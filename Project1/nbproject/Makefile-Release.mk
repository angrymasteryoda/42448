...
${OBJECTDIR}/_ext/1490137145/Card.o: ../Project1/Card.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1490137145/Card.o ../Project1/Card.cpp

${OBJECTDIR}/_ext/1490137145/Deck.o: ../Project1/Deck.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1490137145
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1490137145/Deck.o ../Project1/Deck.cpp

${OBJECTDIR}/_ext/1490137145/Game.o: ../Project1/Game.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/1490137145
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/1490137145/Game.o ../Project1/Game.cpp
